...
6)  Neuropathology Data 
	neuropath_through2021_234 (FHS Brain Donor Neuropathology Data) 
...
/*sort the datasets by FRAMID*/
proc sort data=wt_1_2; 
by framid;
run;
proc sort data=wt_7_2;
by framid;
run;
...
proc sort data=wt_17_1; 
by framid; 
run; 
proc sort data=race_17; 
by framid; 
run; 
proc sort data=diabetes_1; 
by framid; 
run; 
proc sort data=diabetes_7; 
by framid; 
run; 
...
data chd_all_cohort_1 stroke_all_cohort_1 ;
...
set in1.neuropath_through2021_234;
*Creating universal identifer variables - framid;
neuropath_avail = 1; 
if idtype=0 then framid=id;
else if idtype=1 then framid=id+80000;
...
proc print data=out1.curated_bap_17_0123;
...
PROC EXPORT DATA= WORK.csv_curated_17
            OUTFILE= "C:\Users\angtf\Desktop\Test_SAS\Output_data\curated_bap_17_0123_nolabel.csv" 
