...
The purpose of this SAS code is to allow users to create similar data structure and naming convention to that of the FHS-BAP Gen2/Omni1 
...
proc print data=prevalence_cohort17_1 (obs=10); 
...
data edu_17; 
set edu_17_0; 
if idtype = 1 and edu_all = . then do; 
...
data out1.curated_bap_17_02012024;
...
proc print data=out1.curated_bap_17_02012024;
...
data csv_curated_17; 
set out1.curated_bap_17_02012024;
run; 
...
PROC EXPORT DATA= WORK.csv_curated_17
            OUTFILE= "C:\Users\angtf\Desktop\Test_SAS\Output_data\curated_bap_17_02012024_nolabel.csv" 
