...
1)  Gen 2 workthru - vr_wkthru_ex09_1_1001
	Omni 1 workthru - vr_wkthru_ex04_7_0917
	vr_raceall_2008_a_0712 (FHS race/ethnicity information) 

2)  NP Summary Score - np_summary_through2021_17629

3)  Dementia Review - demrev_through2021_4197

4)  Commonly used outcomes (CHD, Stroke, AF, Diabetes and Cancer): 
	vr_soe_2020_a_1340 (Verified Sequence of Events (SOE) Cardiovascular Endpoints)
	vr_afcum_2020_a_1317 (verified Atrial Fibrillation/Flutter dataset)
	vr_diab_ex09_1_1002 (Verified Diabetes dataset for Gen 2)
	vr_diab_ex04_7_1339 (Verified Diabetes dataset for Omni1)
	vr_cancer_2019_a_1162_v1 (Verified Cancer dataset)
	vr_survdth_2019_a_1337 (Verified Survival Status dataset) 
...
5) 	Individual FHS exam questionnaires: 
	...
	vr_mmse_ex09_1b_0943 (Verified Gen 2/Omni1 MMSE dataset)
...
******************************************************************************************************************************************
Renaming variables within Gen2/Omni1 workthru dataset
******************************************************************************************************************************************

*Read in the Gen 2 workthru dataset by using a data step;
data wt_1_1;
set in1.vr_wkthru_ex09_1_1001;
*Creating universal identifer variables - framid;
framid=id+80000;
*drop ATT1-ATT9 (attended exams 1-9) from the dataset;
drop att1-att9;
run;

*rename the variables w/ a generic name variable_core()
with the rename function for the Gen 2 workthru dataset in another data step;
data wt_1_2;
set wt_1_1;
rename 
	age1-age9=age_core1-age_core9
   	bg1-bg9=BG_core1-BG_core9
   	bmi1-bmi9=BMI_core1-BMI_core9
   	calc_LDL1-calc_LDL9=calc_LDL_core1-calc_LDL_core9
   	cpd1-cpd9=CPD_core1-CPD_core9
   	creat2=Creatinine_core2
   	creat5-creat9=Creatinine_core5-Creatinine_core9
   	currsmk1-currsmk9=Smoking_core1-Smoking_core9
   	date1-date9=Date_core1-Date_core9
   	dbp1-dbp9=DBP_core1-DBP_core9
   	dlvh1-dlvh9=DLVH_core1-DLVH_core9
   	Fasting_BG3-Fasting_BG9=Fasting_BG_core3-Fasting_BG_core9
   	HDL1-HDL9=HDL_core1-HDL_core9
   	hgt1-hgt9=height_core1-height_core9
   	hip4=Hip_core4
   	hip5=Hip_core5
   	hip6=Hip_core6
   	hip7=Hip_core7
   	hip9=Hip_core9
   	sbp1-sbp9=SBP_core1-SBP_core9
   	tc1-tc9=TC_core1-TC_core9
   	trig1-trig9=Triglycerides_core1-Triglycerides_core9
   	vent_rt1-vent_rt9=Vent_rt_core1-Vent_rt_core9
   	waist4-waist9=Waist_core4-Waist_core9
	wgt1-wgt9=Weight_core1-Weight_core9
   	dmrx1-dmrx9=DMRX_core1-DMRX_core9
   	hrx1-hrx9=HRX_core1-HRX_core9
   	liprx1-liprx9=LIPRX_core1-LIPRX_core9
;
run;

/*read in the Omni 1 workthru dataset*/
data wt_7_1;
set in1.vr_wkthru_ex04_7_0917;
*Creating universal identifer variables - framid;
framid=id+700000;
/*drop ATT1-ATT4 from datasets*/
drop att1-att4;
run;
...
length Height_core1-Height_core9 HDL_core1-HDL_core9 TC_core1-TC_core9 Triglycerides_core1-Triglycerides_core9 Vent_RT_core1-Vent_RT_core9 Weight_core1-Weight_core9 8;
set wt_1_2 wt_7_2;
by framid;
run;
...
keep framid race_code;
run; 

*Read in verified Gen 2 diabetes dataset by using a data step;
data diabetes_1; 
retain framid; 
set in1.vr_diab_ex09_1_1002; 
*Creating universal identifer variables - framid;
framid=id+80000;
drop idtype id; 
rename
CURR_DIAB1-CURR_DIAB9=Curr_dm_core1-Curr_dm_core9
HX_DIAB1-HX_DIAB9=Hx_dm_core1-Hx_dm_core9
;
run; 

*Read in verified Omni 1 diabetes dataset by using a data step;
data diabetes_7; 
retain framid; 
set in1.vr_diab_ex04_7_1339; 
*Creating universal identifer variables - framid;
framid=id+700000;
drop idtype id; 
rename
CURR_DIAB1=Curr_dm_core5
CURR_DIAB2-CURR_DIAB4=Curr_dm_core7-Curr_dm_core9
HX_DIAB1=Hx_dm_core5
HX_DIAB2-HX_DIAB4=Hx_dm_core7-Hx_dm_core9
;
run; 
...
data backbone_17;
retain idtype id framid sex race_code; 
...
set in1.np_summary_through2021_17629;
*Creating universal identifer variables - framid;
if idtype=0 then framid=id;
else if idtype=1 then framid=id+80000;
else if idtype=2 then framid=id+20000;
...
set in1.demrev_through2021_4197;
*Creating universal identifer variables - framid;
if idtype=0 then framid=id;
else if idtype=1 then framid=id+80000;
else if idtype=2 then framid=id+20000;
...
set in1.vr_survdth_2019_a_1337;
*Creating universal identifer variables - framid;
if idtype=0 then framid=id;
else if idtype=1 then framid=id+80000;
else if idtype=2 then framid=id+20000;
...
array prevalent_chd_core[9] ; 
array prevalent_stroke_core[9] ; 
array prevalent_af_core[9] ;
array prevalent_dementia_core[9] ; 
array prevalent_cancer_core[9] ;
array prevalent_strokerisk_core[9] ;
...
data mmse_17_1;
retain framid cogscr_core5-cogscr_core9 maxcog_core5-maxcog_core9; 
...
data CESD_17;
retain framid; 
merge exam6_1_1 exam7_17_1 exam9_17_1;
by framid;
run;
...
******************************************************************************************************************************************
Education information from individual FHS exam questionnaires
******************************************************************************************************************************************
...
*Append three FHS education datasets together;
data edu_17; 
merge edu_exam2_1 edu_exam8_1 edu_exam8_7; 
by framid; 
run; 
...
data out1.fsrp_17_0423;
set prevalence_cohort17; 
array date_core[*] date_core:; 
array age_core[*] age_core:; 
array age_fsrp_core[9]; 

array sbp_core[*] sbp_core:; 
array sbp_fsrp_core[9]; 

array hrx_core[*] hrx_core:; 
array hrx_fsrp_core[9]; 

array Hx_dm_core[*] Hx_dm_core:; 
array dm_fsrp_core[9]; 

array smoking_core[*] smoking_core:; 
array smoking_fsrp_core[9]; 

array precvd_core[*] prevalent_strokerisk_core:; 
array precvd_fsrp_core[9]; 

array preaf_core[*] prevalent_af_core:; 
array preaf_fsrp_core[9]; 

array DLVH_core[*] DLVH_core:; 
array dlvh_fsrp_core[9]; 

array fsrp_core[9]; 
array revised_fsrp_core[9]; 
...
data out1.curated_bap_17_0423;
retain idtype id framid sex race_code date_core1-date_core9 age_core1-age_core9 edu_core2 edu_core8;
merge  
backbone_17 (in=in1)
NP_cohort17_2
date_matching_2
...
if framid = 703588 then delete; 
if in1;
run; 


*Check format and accuracy; 
proc print data=out1.curated_bap_17_0423;
...
PROC EXPORT DATA= WORK.csv_curated_17
            OUTFILE= "C:\Users\angtf\Desktop\Test_SAS\Output_data\curated_bap_17_0423_nolabel.csv" 
