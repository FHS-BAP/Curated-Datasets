...
if race_code in ("B", "BB", "BEB", "BHB", "EB", "EBB", "EBEB", "HHB") then race = 2;
else if race_code in ("A", "EA", "EAA", "EAEA", "HHA") then race = 3;
else if race_code in ("E", "EW", "W", "EEW", "EWE", "EWEW", "EWW", "WH", "EWHW", "H", "HH", "HHW", "HW", "WHHW", "") then race = 1;
else if race_code in ("EPEP", "X") then race = 4;
else if race_code in ("N", "HHN") then race = 5;
else race = 6;
*Creating derived variable - Ethnicity;
if race_code in ("BHB", "H", "HHA", "HH", "HHB", "HHBN", "HHN", "HHR", "HHW", "HHWB", "HHWBA", "HHWN", "HOHR", "HOHW", "HW", "WH", "WHAHWA", "WHHR", "WHHW") then ethnicity = 2; 
else ethnicity = 1;
...
data out1.curated_bap_17_10312024;
...
proc print data=out1.curated_bap_17_10312024;
...
data csv_curated_17; 
set out1.curated_bap_17_10312024;
run; 
...
PROC EXPORT DATA= WORK.csv_curated_17
            OUTFILE= "C:\Users\angtf\SAS_files\Output_files\curated_bap_17_10312024_nolabel.csv" 
