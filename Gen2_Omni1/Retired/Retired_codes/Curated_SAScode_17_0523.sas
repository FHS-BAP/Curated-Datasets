...
2)  NP Summary Score - np_summary_through2022_18053

3)  Dementia Review - demrev_through2022_4308

4)  Commonly used outcomes (CHD, Stroke, AF, Diabetes and Cancer): 
	vr_soe_2021_a_1385 (Verified Sequence of Events (SOE) Cardiovascular Endpoints)
	vr_afcum_2021_a_1366 (verified Atrial Fibrillation/Flutter dataset)
	...
	vr_survdth_2020_a_1404 (Verified Survival Status dataset) 
...
set in1.vr_survdth_2020_a_1404;
*Creating universal identifer variables - framid;
if idtype=0 then framid=id;
else if idtype=1 then framid=id+80000;
else if idtype=2 then framid=id+20000;
...
proc print data=out1.curated_bap_17_0523;
...
PROC EXPORT DATA= WORK.csv_curated_17
            OUTFILE= "C:\Users\angtf\Desktop\Test_SAS\Output_data\curated_bap_17_0523_nolabel.csv" 
