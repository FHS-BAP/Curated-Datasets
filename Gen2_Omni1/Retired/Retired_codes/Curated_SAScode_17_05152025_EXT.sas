...
1)  vr_wkthru_ex10_1b_1488 (Gen 2/Omni 1 workthru)
	vr_raceall_2011_a_1257 (FHS race/ethnicity information) 
...
5) 	Individual FHS exam questionnaires: 
	e_exam_ex01_1_0079_v2 (Gen 2 exam 1)
	e_exam_ex02_1_0080_v1 (Gen 2 exam 2)
	e_exam_ex03_1_0081 (Gen 2 exam 3)
	e_exam_ex04_1_0082 (Gen 2 exam 4) 
	e_exam_ex05_1_0083_v1 (Gen 2 exam 5)
...
retain framid; 
set in1.vr_raceall_2011_a_1257; 
*Creating universal identifer variables - framid;
...
data out1.curated_bap_17_05152025;
...
proc print data=out1.curated_bap_17_05152025;
...
data csv_curated_17; 
set out1.curated_bap_17_05152025;
run; 
...
PROC EXPORT DATA= WORK.csv_curated_17
            OUTFILE= "C:\Users\angtf\SAS_files\Output_files\curated_bap_17_05152025_nolabel.csv" 
...
data out1.curated_bap_17_05152025_EXT; 
