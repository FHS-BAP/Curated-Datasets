...
data out1.curated_bap_0_05202024;
...
proc print data=out1.curated_bap_0_05202024;
...
data csv_curated_0; 
set out1.curated_bap_0_05202024;
run; 
...
run;
quit;
filename csv "C:\Users\angtf\Desktop\Test_SAS\Output_data\curated_bap_0_05202024_nolabel.csv" lrecl=10000000;
