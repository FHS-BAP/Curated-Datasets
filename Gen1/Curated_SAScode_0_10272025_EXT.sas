...
The purpose of this SAS code is to allow users to create similar data structure and naming convention to that of the Gen1
...
5) 	Individual FHS exam questionnaires: 
	e_exam_ex07_0_0076_v2 (Gen 1 Exam 1-7)
...
libname in1 'C:\Users\mcum\Desktop\SAS_curated_files\curated_1\Input_files';
*Provide the location of the derived datasets to export to before you run the SAS code. ;
libname out1 'C:\Users\mcum\Desktop\SAS_curated_files\curated_1\Output_files';
...
data exam22_0_1;
set exam22_0;
label CESD_1_core22='I was bothered by things that usually don_t bother me (at exam 22)'
...
data exam23_0_1;
set exam23_0;
label CESD_1_core23='I was bothered by things that usually don_t bother me (at exam 23)'
...
data exam25_0_1;
set exam25_0;
label CESD_1_core25='I was bothered by things that usually don_t bother me (at exam 25)'
...
data exam26_0_1;
set exam26_0;
label CESD_1_core26='I was bothered by things that usually don_t bother me (at exam 26)'
...
data exam27_0_1;
set exam27_0;
label CESD_1_core27='I was bothered by things that usually don_t bother me (at exam 27)'
...
data exam28_0_1;
set exam28_0;
label CESD_1_core28='I was bothered by things that usually don_t bother me (at exam 28)'
...
data exam29_0_1;
set exam29_0;
label CESD_1_core29='I was bothered by things that usually don_t bother me (at exam 29)'
...
data exam30_0_1;
set exam30_0;
label CESD_1_core30='I was bothered by things that usually don_t bother me (at exam 30)'
...
data exam31_0_1;
set exam31_0;
label CESD_1_core31='I was bothered by things that usually don_t bother me (at exam 31)'
...
data exam32_0_1;
set exam32_0;
label CESD_1_core32='I was bothered by things that usually don_t bother me (at exam 32)'
...
data out1.curated_bap_0_10272025;
retain idtype id framid sex race_code race ethnicity date_core1-date_core32 age_core1-age_core32 edu_core1 edu_all;
merge  
backbone_0
NP_cohort0_2
date_matching_2
...
proc print data=out1.curated_bap_0_10272025;
...
data csv_curated_0; 
set out1.curated_bap_0_10272025;
run; 
...
run;
quit;
filename csv "C:\Users\mcum\Desktop\SAS_curated_files\curated_1\Output_files\curated_bap_0_10272025_nolabel.csv" lrecl=10000000;
...
******************************************************************************************************************************************
Creation of curated dataset (Gen 1) FOR EXTERNAL USE
******************************************************************************************************************************************;
data out1.curated_bap_0_10272025_EXT; 
set csv_curated_0; 
