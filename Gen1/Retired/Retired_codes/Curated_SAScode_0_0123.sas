...
1)  Gen1 Workthru - vr_wkthru_ex32_0_0997
...
proc sort data=wt_0_1; 
by framid; 
run; 
proc sort data=race_0; 
by framid; 
run; 
proc sort data=diabetes_0; 
by framid; 
run; 
...
if 0 then set wt_0_2 (keep=Date_core:) wt_0_2 (keep=Age_core:) wt_0_2 (keep=Height_core:) wt_0_2 (keep=Weight_core:) wt_0_2 (keep=BMI_core:) wt_0_2 (keep=Hip_core:) wt_0_2 (keep=Waist_core:) wt_0_2 (keep=Smoking_core:) wt_0_2 (keep=CPD_core:) wt_0_2 (keep=SBP_core:) wt_0_2 (keep=DBP_core:) wt_0_2 (keep=Vent_RT_core:) wt_0_2 (keep=DLVH_core:) wt_0_2 (keep=HRX_core:) wt_0_2 (keep=BG_core:) wt_0_2 (keep=DMRX_core:) wt_0_2 (keep=curr_dm_core:) wt_0_2 (keep=hx_dm_core:) wt_0_2 (keep=TC_core:) wt_0_2 (keep=HDL_core:) wt_0_2 (keep=Triglycerides_core:) wt_0_2 (keep=Calc_LDL_core:) wt_0_2 (keep=LIPRX_core:) wt_0_2 (keep=Creatinine_core:);
set wt_0_2;
run;
...
/*macro to sort all the datasets by FRAMID*/
...
data out1.curated_bap_0_0123;
retain idtype id framid sex race_code date_core1-date_core32 age_core1-age_core32 edu_core1;
merge  
backbone_0
NP_cohort0_2
date_matching_2
...
proc print data=out1.curated_bap_0_0123;
...
run;
quit;
PROC EXPORT DATA= WORK.csv_curated_0
            OUTFILE= "C:\Users\angtf\Desktop\Test_SAS\Output_data\curated_bap_0_0123_nolabel.csv" 
