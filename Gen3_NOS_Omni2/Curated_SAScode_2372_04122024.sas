...
3)  vr_demrv_through2023_4425 (Dementia Review)
...
set in1.vr_demrv_through2023_4425;
*Creating universal identifer variables - framid;
if idtype=0 then framid=id;
else if idtype=1 then framid=id+80000;
else if idtype=2 then framid=id+20000;
...
if edu_all = . then do; 
	if edu_core2 in (0,1,2) then edu_all = 0; 
		...
		if edu_core1 in (0,1,2) then edu_all = 0;
			...
			if educg_np1 = 0 then edu_all = 0;
			else if educg_np1 = 1 then edu_all = 1;
			else if educg_np1 = 2 then edu_all = 2;
			else if educg_np1 = 3 then edu_all = 3;
			else if educg_np1 = . then do; 
...
data out1.curated_bap_2372_04122024;
...
proc print data=out1.curated_bap_2372_04122024;
...
set out1.curated_bap_2372_04122024;
run; 
...
PROC EXPORT DATA= WORK.csv_curated_2372
            OUTFILE= "C:\Users\angtf\Desktop\Test_SAS\Output_data\curated_bap_2372_04122024_nolabel.csv" 
