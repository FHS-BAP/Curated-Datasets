******************************************************************************************************************************************
Introduction to Gen3/Omni2/NOS curated dataset [FOR EXTERNAL USE] source code
******************************************************************************************************************************************
...
5) 	Individual FHS exam questionnaires: 
	e_exam_ex01_3_0086_v3 (Gen 3 exam 1)
	e_exam_ex01_72_0652 (Omni 2 exam 1)
	e_exam_ex01_2_0813 (NOS exam 1)
	e_exam_ex02_3b_0017_v2 (Gen 3/Omni 2/NOS exam 2)
	e_exam_ex03_3b_1069_v1 (Gen 3/Omni 2/NOS exam 3)
...
libname in1 'C:\Users\mcum\Desktop\SAS_curated_files\curated_3\Input_files';
*Provide the location of the derived datasets to export to before you run the SAS code. ;
libname out1 'C:\Users\mcum\Desktop\SAS_curated_files\curated_3\Output_files';
...
******************************************************************************************************************************************
Alcohol consumption for Gen 3/ Omni 2/NOS
******************************************************************************************************************************************
...
/*Gen 3 exam 1 alcohol data extraction*/
data alcohol_gen3_1; 
set in1.e_exam_ex01_3_0086_v3;
   beerperweek1=G3A115;
   whiteperweek1=G3A119;
   redperweek1=G3A123;
   liquorperweek1=G3A127;
/*Calculate number of drinks and alcohol consumption per week*/
  drinksperweek1 = sum(of beerperweek1 whiteperweek1 redperweek1 liquorperweek1);
  gramsperday1 = sum(beerperweek1*13.9 , 15*whiteperweek1, 15*redperweek1,14*liquorperweek1)/7;
/*Create universal identifier - framid */
  framid = id + 30000;
keep framid beerperweek1 whiteperweek1 redperweek1 liquorperweek1 drinksperweek1 gramsperday1;
run;

/*Omni 2 exam 1 alcohol data extraction*/
data alcohol_omni2_1; 
...
/*NOS exam 1 alcohol data extraction*/
data alcohol_nos_1; 
...
/*Gen 3/Omni 2/NOS exam 2 alcohol data extraction*/
data alcohol_2; 
set in1.e_exam_ex02_3b_0017_v2;
  beerperweek2   = G3B0105;
  wineperweek2   = G3B0107;
  liquorperweek2 = G3B0109;
/*Calculate number of drinks and alcohol consumption per week*/
...
/*Create universal identifier - framid */
  ...
  else if idtype = 72 then framid = id + 720000;
keep framid beerperweek2 wineperweek2 liquorperweek2 drinksperweek2 gramsperday2;
run;

/*Gen 3/Omni 2/NOS exam 3 alcohol data extraction*/
data alcohol_3; 
set in1.e_exam_ex03_3b_1069_v1;
  beerperweek3   = G3C0264;
  wineperweek3   = G3C0268;
  liquorperweek3 = G3C0272;
/*Calculate number of drinks and alcohol consumption per week*/
...
%sort(list_sex_2372, framid);
%sort(alcohol_gen3_1, framid);
%sort(alcohol_omni2_1, framid);
%sort(alcohol_nos_1, framid);
%sort(alcohol_2, framid);
%sort(alcohol_3, framid);


/*Merging all alcohol datasets*/
data alcohol_13_2372;
merge list_sex_2372 (in=inback) alcohol_gen3_1 alcohol_omni2_1 alcohol_nos_1 alcohol_2 alcohol_3;
by framid;
if inback;
/*Creating dichotomous drinking status based on drinks per week*/
array drink{*} drinksperweek1-drinksperweek3; 
array drink_status{*} currdrink1-currdrink3; 
do h = 1 to dim (drink);
...
array currdrink{*} currdrink2-currdrink3; 
array drinksum{*} currdrink1 drinksum2-drinksum3; 
array drinking_ever{*} drinking_ever2-drinking_ever3; 
...
array gramsperday{*} gramsperday1-gramsperday3;
array alccat{*} alccat1-alccat3; 
...
/*Rename using Gen 3/Omni 2/NOS curated dataset naming convention*/
data alcohol_13_2372_1;
retain idtype id framid sex beerperweek1-beerperweek3 whiteperweek1 redperweek1 wineperweek2-wineperweek3 liquorperweek1-liquorperweek3 drinksperweek1-drinksperweek3 gramsperday1-gramsperday3 currdrink1-currdrink3 drinking_ever2-drinking_ever3 alccat1-alccat3;
set alcohol_13_2372;
rename
beerperweek1-beerperweek3=beerperweek_core1-beerperweek_core3
whiteperweek1=whiteperweek_core1
redperweek1=redperweek_core1 
wineperweek2-wineperweek3=wineperweek_core2-wineperweek_core3
liquorperweek1-liquorperweek3=liquorperweek_core1-liquorperweek_core3
drinksperweek1-drinksperweek3=drinksperweek_core1-drinksperweek_core3
gramsperday1-gramsperday3=gramsperday_core1-gramsperday_core3
currdrink1-currdrink3=currdrink_core1-currdrink_core3
drinking_ever2-drinking_ever3=drinking_ever_core2-drinking_ever_core3
alccat1-alccat3=alccat_core1-alccat_core3;
drop id idtype sex;
run;
...
array np_closest_exam_date[6] ; 
array np_days_apart[6] ; 
array np_exam_cycle[6] ; 
...
array examdate_np[*] examdate_np:; 
array date_core[*] date_core:; 
array np_closest_exam_date[6] np_closest_exam_date:; 
array np_days_apart[6] np_days_apart:; 
array np_exam_cycle[6] np_exam_cycle:;
do i = 1 to dim(examdate_np); 
...
array date_core[*] date_core:; 
array examdate_np[*] examdate_np1-examdate_np6; 
...
array prevalent_chd_NP[6] ; 
array prevalent_stroke_NP[6] ; 
array prevalent_af_NP[6] ;
array prevalent_dementia_NP[6] ; 
array prevalent_cancer_NP[6] ;
array prevalent_strokerisk_NP[6] ;
...
data out1.curated_bap_2372_10272025;
retain idtype id framid sex race_code race ethnicity date_core1-date_core3 age_core1-age_core3 edu_core1-edu_core3 edu_all;
merge  
backbone_2372
alcohol_13_2372_1
NP_cohort2372_2
...
proc print data=out1.curated_bap_2372_10272025;
*Should have 1 observation with 6 NP assessments; 
where examdate_np6 ne .;
run; 

*Remove label for csv file; 
data csv_curated_2372; 
set out1.curated_bap_2372_10272025;
run; 
...
PROC EXPORT DATA= WORK.csv_curated_2372
            OUTFILE= "C:\Users\mcum\Desktop\SAS_curated_files\curated_3\Output_files\curated_bap_2372_10272025_nolabel.csv" 
...
******************************************************************************************************************************************
Creation of curated dataset (Gen 3 NOS Omni 2) FOR EXTERNAL USE
******************************************************************************************************************************************;

data out1.curated_bap_2372_10272025_EXT; 
set csv_curated_2372; 
...
array outcome[*] normal_date  impairment_date  mild_date  moderate_date  severe_date  eddd  first_chd_date  first_stroke_date  first_af_date  first_cancer_date  last_contact_date  death_date ; 
...
date_core1 = 0;  
drop i j k race_code; 
format date_core: examdate_np: np_closest_exam_date: normal_date  impairment_date  mild_date  moderate_date  severe_date  eddd  first_chd_date  first_stroke_date  first_af_date  first_cancer_date  last_contact_date  death_date ; 
run; 
