...
data out1.curated_bap_2372_0523;
...
proc print data=out1.curated_bap_2372_0523;
*Should have 3 observations with 5 NP assessments; 
where examdate_np5 ne .;
run; 

*Remove label for csv file; 
data csv_curated_2372; 
set out1.curated_bap_2372_0523;
run; 
...
PROC EXPORT DATA= WORK.csv_curated_2372
            OUTFILE= "C:\Users\angtf\Desktop\Test_SAS\Output_data\curated_bap_2372_0523_nolabel.csv" 
