...
1)  Gen 3/Omni 2/NOS workthru - vr_wkthru_ex03_3b_1191
...
if 0 then set wt_2372_3 (keep=Date_core:) wt_2372_3 (keep=Age_core:) wt_2372_3 (keep=Height_core:) wt_2372_3 (keep=Weight_core:) wt_2372_3 (keep=BMI_core:) wt_2372_3 (keep=Hip_core:) wt_2372_3 (keep=Waist_core:) wt_2372_3 (keep=Smoking_core:) wt_2372_3 (keep=CPD_core:) wt_2372_3 (keep=SBP_core:) wt_2372_3 (keep=DBP_core:) wt_2372_3 (keep=Vent_RT_core:) wt_2372_3 (keep=DLVH_core:) wt_2372_3 (keep=HRX_core:) wt_2372_3 (keep=BG_core:) wt_2372_3 (keep=Fasting_BG_core:) wt_2372_3 (keep=DMRX_core:) wt_2372_3 (keep=curr_dm_core:) wt_2372_3 (keep=hx_dm_core:) wt_2372_3 (keep=TC_core:) wt_2372_3 (keep=HDL_core:) wt_2372_3 (keep=Triglycerides_core:) wt_2372_3 (keep=Calc_LDL_core:) wt_2372_3 (keep=LIPRX_core:) wt_2372_3 (keep=Creatinine_core:);
set wt_2372_3;
run;
...
array np_closest_exam_date[4] ; 
array np_days_apart[4] ; 
array np_exam_cycle[4] ; 
...
array examdate_np[*] examdate_np:; 
array date_core[*] date_core:; 
array np_closest_exam_date[4] np_closest_exam_date:; 
array np_days_apart[4] np_days_apart:; 
array np_exam_cycle[4] np_exam_cycle:;
do i = 1 to dim(examdate_np); 
...
array date_core[*] date_core:; 
array examdate_np[*] examdate_np1-examdate_np4; 
...
array prevalent_chd_NP[4] ; 
array prevalent_stroke_NP[4] ; 
array prevalent_af_NP[4] ;
array prevalent_dementia_NP[4] ; 
array prevalent_cancer_NP[4] ;
array prevalent_strokerisk_NP[4] ;
...
data exam1_2372_1;
set exam1_2372;
label cesd_1_core1='I was bothered by things that usually dont bother me (at exam 1)'
...
data exam2_2372_1;
set exam2_2372;
label cesd_1_core2='I was bothered by things that usually dont bother me (at exam 2)'
...
data exam3_2372_1;
set exam3_2372;
label cesd_1_core3='I was bothered by things that usually dont bother me (at exam 3)'
...
data edu_2372; 
merge edu_exam1_2372 edu_exam2_2372 edu_exam3_2372; 
by framid; 
run; 
...
data out1.curated_bap_2372_0423;
retain idtype id framid sex race_code date_core1-date_core3 age_core1-age_core3 edu_core1-edu_core3;
merge  
backbone_2372
NP_cohort2372_2
date_matching_2
...
proc print data=out1.curated_bap_2372_0423;
*Should have 12 observations with 4 NP assessments; 
where examdate_np4 ne .;
run; 

*Remove label for csv file; 
data csv_curated_2372; 
set out1.curated_bap_2372_0423;
run; 
...
PROC EXPORT DATA= WORK.csv_curated_2372
            OUTFILE= "C:\Users\angtf\Desktop\Test_SAS\Output_data\curated_bap_2372_0423_nolabel.csv" 
