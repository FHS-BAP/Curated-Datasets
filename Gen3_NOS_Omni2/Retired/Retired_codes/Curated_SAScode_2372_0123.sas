...
proc sort data=wt_2372_2; 
by framid; 
run; 
proc sort data=race_2372; 
by framid; 
run; 
proc sort data=diabetes_2372; 
by framid; 
run; 
...
data out1.curated_bap_2372_0123;
...
proc print data=out1.curated_bap_2372_0123;
...
set out1.curated_bap_2372_0123;
run; 
...
PROC EXPORT DATA= WORK.csv_curated_2372
            OUTFILE= "C:\Users\angtf\Desktop\Test_SAS\Output_data\curated_bap_2372_0123_nolabel.csv" 
